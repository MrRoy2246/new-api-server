...
from .views import VisitorAPIView, RestoreVisitorAPIView,VisitorTrackAPIView,MLDetectionAPIView,VisitorDetectionsAPIView
...
urlpatterns = [
    ...
    path('visitor/<int:pk>/', VisitorAPIView.as_view()),     # Detail, Update, Delete
    path('visitor/<int:pk>/restore/', RestoreVisitorAPIView.as_view()),  # Restore
    ...
    path('api/visitor/<int:visitor_id>/detections/', VisitorDetectionsAPIView.as_view(), name='visitor-detections'),
