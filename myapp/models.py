...
class Visitor(models.Model):
    ...
    # visitor_type = models.IntegerField(choices=VISITOR_TYPE_CHOICES, default=3)
...
class VisitorEventHistory(models.Model):
    ...
    def __str__(self):
        return f"Event at {self.camera_location} on {self.capture_time.strftime('%Y-%m-%d %H:%M:%S')}"
